 ...
 */
public class GetClientReservedLessons extends Env {
    @Test(priority = 1, dataProvider = "data", description = "课前预习列表获取", groups = {"Information.Api 3.0"})
    public void getClientReservedLessons(Map<String, String> dataDriven) throws IOException {
        ...
        GetClientReservedLessonsMsg.getClientReservedLessons(Integer.valueOf(dataDriven.get("brandId")), Integer.valueOf(ClientSN), Integer.valueOf(dataDriven.get("lessonType")), BeginTime, EndTime);
    ...
    public Iterator<Object[]> data() {
        ...
        return new ExcelProvider(this, "getClientReservedLessons");
    }
}
