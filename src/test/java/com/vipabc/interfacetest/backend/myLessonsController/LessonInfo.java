 ...
 */
public class LessonInfo extends Env {
    HttpFixture hf = new HttpFixture();
    @Test(priority = 1, dataProvider = "data", description = "课后复习相关信息", groups = {"functiontest"})
    public void lessonInfo(Map<String, String> dataDriven) throws IOException {
    ...
    public Iterator<Object[]> data() {
        ...
        return new ExcelProvider(this, "lessonInfo");
    }
}
