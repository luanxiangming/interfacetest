 ...
 */
public class GetList extends Env {
    HttpFixture hf = new HttpFixture();
    @Test(priority = 1, dataProvider = "data", description = "故事绘本", groups = {"functiontest"})
    public void getList(Map<String, String> dataDriven) throws IOException {
        ...
        GetListMsg.getList(hf, dataDriven.get("requestPage"), cookies);
    ...
    public Iterator<Object[]> data() {
        ...
        return new ExcelProvider(this, "getList");
    }
}
