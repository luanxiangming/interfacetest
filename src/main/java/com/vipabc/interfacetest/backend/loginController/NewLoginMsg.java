...
public class NewLoginMsg extends BaseMsg {
    ...
    public static void newLogin2(String account, String password, boolean rememberMe, boolean fromIms) {
    ...
    public static void newLogin2(String account, String password) {
        newLogin2(account, password, false, false);
    }
}
