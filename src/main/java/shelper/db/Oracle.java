...
public class Oracle {
        ...
        private Boolean connect(String connect,String username,String pass){
            try
            {
              ...
              Logger.getLogger(Oracle.class.getName()).log(Level.SEVERE, null, e1);
            }
            ...
            try {
              ...
              Logger.getLogger(Oracle.class.getName()).log(Level.SEVERE, null, e2);
            }
            return false;
          }
        /*
     ...
     */
        ...
        try {
            ...
            return result;
                ...
                Logger.getLogger(Oracle.class.getName()).log(Level.SEVERE, null,"oracle statement create failed");
            }
     ...
     public boolean Update(String sql){
        ...
        try {
          ...
          Logger.getLogger(Oracle.class.getName()).log(Level.SEVERE, null, e);
        }
        boolean result=(i != 0);
        Reporter.log("Update\nSQL:"+sql+"\nResult:"+result,true);
        return result;
